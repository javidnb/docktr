		...
		<div class="row mt-3 pb-5">
			<div class="col-12 col-md-3 cl-lg-2">
				{#if !mobileComponent}
					...
					<ul
						class="list-group mobileOnly w-100"
						style="    
						min-height: 75vh;
						background: white;
				}"
			...
			{#if mobileComponent}
				<div class="col-md-9 col-lg-9 kont px-0">
					<div class="container">
						<div class="row">
							<div class="col-12 mobileOnly" style="min-height: 75dvh; background-color: white">
								<div class="container">
			...
			{:else}
				<div class="col-md-9 col-lg-9 kont pcOnly">
					<div class="container">
						<div class="row">
